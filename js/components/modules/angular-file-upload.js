...
/***/ function(module, exports, __webpack_require__) {
	...
	function __identity(fileUploaderOptions, $rootScope, $http, $window, $timeout, FileLikeObject, FileItem, Pipeline) {
	    ...
	    var FileUploader = function () {
	        ...
	        FileUploader.prototype.onProgressItem = function onProgressItem(fileItem, progress, event) {};
	        /**
	         * Callback
	         * @param {Number} progress
	         */
	        ...
	        */
	        ...
	        FileUploader.prototype._xhrTransport = function _xhrTransport(item) {
	            ...
	            xhr.upload.onprogress = function (event) {
	                ...
	                _this5._onProgressItem(item, progress, event);
	            };
	        ...
	        FileUploader.prototype._onProgressItem = function _onProgressItem(item, progress, event) {
	            var total = this._getTotalProgress(progress);
	            this.progress = total;
	            item._onProgress(progress, event);
	            this.onProgressItem(item, progress, event);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __identity($compile, FileLikeObject) {
	    ...
	    return function () {
	        ...
	        FileItem.prototype.onProgress = function onProgress(progress, event) {};
	        /**
	         * Callback
	         * @param {*} response
	         * @param {Number} status
	        ...
	        FileItem.prototype._onProgress = function _onProgress(progress, event) {
	            this.progress = progress;
	            this.onProgress(progress, event);
	        };
	        /**
	         * Inner callback
	         * @param {*} response
