      ...
      function (treeConfig, $window) {
        return {
          ...
          link: function (scope, element, attrs, ctrl) {
            ...
            /**
             * Callback is fired each time the common starts dragging a node
             * @param event
             */
            ...
            /**
             * Callback is fired when the tree exits drag mode. If the common dropped a node, the drop may have been
            ...
            /**
             * Callback is fired when a common drops a node (but prior to processing the drop action)
            ...
            /**
             * Callback is fired when a common toggles node (but after processing the toggle action)
      ...
      function (treeConfig, UiTreeHelper, $window, $document, $timeout, $q) {
        return {
          ...
          link: function (scope, element, attrs, controllersArr) {
            ...
            /**
             * Called when the common has grabbed a node and started dragging it.
             *
            ...
            dragStart = function (e) {
              ...
              //Create a hidden placeholder and add class from provider.
        ...
        return {
          ...
          dragInfo: function (node) {
            return {
              ...
              //Sets arguments passed to common callbacks.
