...
(function(root, factory) {
  ...
  .factory('RzSlider', ['$timeout', '$document', '$window', '$compile', 'RzSliderOptions', 'rzThrottle', function($timeout, $document, $window, $compile, RzSliderOptions, rzThrottle) {
    ...
    Slider.prototype = {
      ...
      /**
       * Read the common options and apply them to the slider model
       */
      ...
      /**
       * Wrapper around the getSelectionBarColor of the common to pass to
       * correct parameters
       */
      ...
      /**
       * Wrapper around the getPointerColor of the common to pass to
       * correct parameters
       */
      ...
      /**
       * Wrapper around the getTickColor of the common to pass to
       * correct parameters
       */
