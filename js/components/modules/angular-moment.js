...
(function () {
	...
	function angularMoment(angular, moment) {
		...
		/**
		 * @ngdoc object
		 * @name angularMoment.provider:angularMomentConfig
		 *
		 * @description
		 ...
		 */
			.constant('angularMomentConfig', {
				 ...
				 * @propertyOf angularMoment.provider:angularMomentConfig
		...
		/**
		 * @ngdoc object
		 * @name angularMoment.provider:amTimeAgoConfig
		 ...
		 */
			.constant('amTimeAgoConfig', {
				 ...
				 * @propertyOf angularMoment.provider:amTimeAgoConfig
