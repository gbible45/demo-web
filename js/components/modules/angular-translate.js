...
function $translate($STORAGE_KEY, $windowProvider, $translateSanitizationProvider, pascalprechtTranslateOverrider) {
   ...
   *
   * @description
   * Tells the module which key must represent the choosed language by a common in the storage.
   *
   ...
   * Example:
   * <pre>
   *  app.provider(function ($translateProvider) {
  ...
  this.$get = ['$log', '$injector', '$rootScope', '$q', function ($log, $injector, $rootScope, $q) {
     ...
     *
     * @description
     * This function simply returns the registered language keys being defined before in the provider phase
