...
(function (window, angular) {
	...
	angular
		...
		.provider('localStorageService', function () {
			...
			// With provider you can use provider as this:
			// myApp.provider(function (localStorageServiceProvider) {
			...
			// Setter for notification provider
			...
			this.$get = ['$rootScope', '$window', '$document', '$parse', '$timeout', function ($rootScope, $window, $document, $parse, $timeout) {
				...
				// If there is a prefix set in the provider lets use that with an appended period for readability
				if (prefix.substr(-1) !== '.') {
				...
				var addToCookies = function (key, value, daysToExpiry, secure) {
					...
					try {
						...
						if (!!key) {
							...
							/* Providing the secure parameter always takes precedence over provider
							...
							if (typeof secure === 'boolean') {
								...
								// else - secure has been supplied but isn't true - so don't set secure flag, regardless of what provider says
							}
							else if (cookie.secure === true) {
								// secure parameter wasn't specified, get default from provider
								cookieDomain += "; secure";
							}
