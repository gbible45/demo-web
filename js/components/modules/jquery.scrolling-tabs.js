 ...
 *      active tab setting selected by the common), for example, if you
...
;(function ($, window) {
  ...
  (function (p) {
    p.initTabs = function (options, $scroller, readyCallback, attachTabContentToDomCallback) {
      ...
      function initTabsAfterTimeout() {
        ...
        // if we're just wrapping non-data-driven tabs, the common might
  ...
  function checkForTabPropertiesUpdated(refreshData) {
    ...
    if (refreshData.options.forceActiveTab) {
      ...
      // DOM state, which could have been changed by the common clicking a tab
